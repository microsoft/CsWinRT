...
internal static class InteropImplTypeResolver
{
        ...
        InteropReferences interopReferences)
    {
        ...
        TypeReference ImplTypeReference = type.DeclaringModule!.CreateTypeReference($"ABI.{type.Namespace}", $"{type.Name}Impl");
        ...
        TypeReference interfaceIIDsTypeReference = type.DeclaringModule!.CreateTypeReference("ABI"u8, "InterfaceIIDs"u8);
