...
internal static partial class SignatureGenerator
{
        ...
        bool useWindowsUIXamlProjections)
    {
        ...
        string? signature = type.ElementType switch
        {
            ...
            ElementType.Class when typeDefinition.IsClass && typeDefinition.IsDelegate => Delegate(typeDefinition, interopReferences),
            ...
            ElementType.Class when typeDefinition.IsInterface => Interface(typeDefinition, interopReferences),
