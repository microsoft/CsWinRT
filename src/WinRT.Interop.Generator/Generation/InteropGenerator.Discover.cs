...
internal partial class InteropGenerator
{
        ...
        string path)
    {
        ...
        // Validate that there's no transitive references to any of the reserved .dll names that we use:
        ...
        //   - 'WinRT.Interop.dll': the interop .dll being generated by this executable.
        if (fileName.SequenceEqual(InteropNames.WindowsRuntimeProjectionDllName) ||
            ...
            fileName.SequenceEqual(InteropNames.WindowsRuntimeInteropDllName))
        {
    ...
    private static InteropReferences CreateDiscoveryInteropReferences(ModuleDefinition module)
    {
        ...
        AssemblyReference windowsRuntimeAssembly = new("WinRT.Runtime2"u8, windowsRuntimeVersion);
