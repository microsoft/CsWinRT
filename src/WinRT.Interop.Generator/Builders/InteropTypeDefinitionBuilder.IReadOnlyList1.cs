    ...
    public static class IReadOnlyList1
    {
            ...
            out TypeDefinition interfaceImplType)
        {
                ...
                baseType: null)
            {
                CustomAttributes =
                {
                    ...
                    InteropCustomAttributeFactory.Guid(readOnlyListType, interopDefinitions, interopReferences, module, useWindowsUIXamlProjections)
                },
                Interfaces =
                {
            ...
            bool useWindowsUIXamlProjections)
        {
            InteropTypeDefinitionBuilder.TypeMapAttributes(
                ...
                metadataTypeMapSourceType: readOnlyListType,
