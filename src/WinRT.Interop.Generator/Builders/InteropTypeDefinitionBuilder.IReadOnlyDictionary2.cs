    ...
    public static class IReadOnlyDictionary2
    {
            ...
            out TypeDefinition vftblType)
        {
            ...
            TypeDefinition newVftblType = WellKnownTypeDefinitionFactory.IReadOnlyDictionary2Vftbl(
                ...
                name: InteropUtf8NameFactory.TypeName(sharedReadOnlyDictionaryType, interopDefinitions, "Vftbl"),
                keyType: keyType,
            ...
            out TypeDefinition mapViewMethodsType)
        {
            ...
            mapViewMethodsType = new TypeDefinition(
                ...
                name: InteropUtf8NameFactory.TypeName(readOnlyDictionaryType, interopDefinitions, "IMapViewMethods"),
            ...
            out TypeDefinition readOnlyDictionaryMethodsType)
        {
            ...
            readOnlyDictionaryMethodsType = new TypeDefinition(
                ns: InteropUtf8NameFactory.TypeNamespace(readOnlyDictionaryType, interopReferences.RuntimeContext),
                name: InteropUtf8NameFactory.TypeName(readOnlyDictionaryType, interopDefinitions, "Methods"),
            ...
            out TypeDefinition interfaceImplType)
        {
            ...
            interfaceImplType = new(
                ns: InteropUtf8NameFactory.TypeNamespace(readOnlyDictionaryType, interopReferences.RuntimeContext),
                name: InteropUtf8NameFactory.TypeName(readOnlyDictionaryType, interopDefinitions, "InterfaceImpl"),
            ...
            out TypeDefinition implType)
        {
            ...
            Impl(
                ...
                ns: InteropUtf8NameFactory.TypeNamespace(readOnlyDictionaryType, interopReferences.RuntimeContext),
                name: InteropUtf8NameFactory.TypeName(readOnlyDictionaryType, interopDefinitions, "Impl"),
                vftblType: vftblType,
                interopDefinitions: interopDefinitions,
                interopReferences: interopReferences,
                module: module,
