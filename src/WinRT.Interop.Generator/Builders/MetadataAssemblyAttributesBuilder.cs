...
#pragma warning restore SYSLIB0003
    ...
    public static void AssemblyAttributes(InteropReferences interopReferences, ModuleDefinition module)
    {
        ...
        module.Assembly!.CustomAttributes.Add(InteropCustomAttributeFactory.AssemblyMetadata("IsTrimmable", "True", interopReferences));
        module.Assembly!.CustomAttributes.Add(InteropCustomAttributeFactory.AssemblyMetadata("IsAotCompatible", "True", interopReferences));
