...
internal static class InteropNames
{
    ...
    /// <summary>
    /// The current name of the Windows Runtime .dll (i.e. <c>WinRT.Runtime2.dll</c>).
    /// </summary>
    public static ReadOnlySpan<byte> WindowsRuntime2DllNameUtf8 => "WinRT.Runtime2.dll"u8;
