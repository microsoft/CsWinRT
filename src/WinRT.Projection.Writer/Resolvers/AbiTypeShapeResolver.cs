...
/// currently live as private static methods inside <c>CodeWriters.Abi.cs</c>. Migration of
...
internal sealed class AbiTypeShapeResolver(MetadataCache cache)
{
    ...
    private AbiTypeShapeKind ClassifyShape(TypeSignature signature)
    {
        ...
        // be folded in here as the inline predicates from CodeWriters.Abi.cs migrate over.
