...
internal sealed class Settings
{
    ...
    /// <summary>
    /// Gets or sets the compiled type-name filter built from <see cref="Include"/> and <see cref="Exclude"/>.
    /// </summary>
    public TypeFilter Filter { get; set; } = TypeFilter.Empty;

    /// <summary>
    /// Gets or sets the compiled type-name filter built from <see cref="Include"/> and <see cref="AdditionExclude"/>, used for namespace-additions resources only.
    /// </summary>
