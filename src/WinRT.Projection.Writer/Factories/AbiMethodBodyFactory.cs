    ...
    internal static void EmitDoAbiBodyIfSimple(IndentedTextWriter writer, ProjectionEmitContext context, MethodSig sig, string ifaceFullName, string methodName)
    {
        ...
        for (int i = 0; i < sig.Params.Count; i++)
        {
            ...
            writer.Write("""
                        ...
                        static extern void CopyToManaged_
                """, isMultiline: true);
            writer.Write(raw);
        ...
        for (int i = 0; i < sig.Params.Count; i++)
        {
            ...
            writer.Write("""
                        ...
                        static extern void CopyToUnmanaged_
                """, isMultiline: true);
            writer.Write(raw);
            writer.Write("([UnsafeAccessorType(\"");
        ...
        foreach (EventDefinition evt in type.Events)
        {
            ...
            writer.Write("""
                    {
                        ...
                        {
                            [MethodImpl(MethodImplOptions.NoInlining)]
                            static ConditionalWeakTable<object, 
                """, isMultiline: true);
            writer.Write(eventSourceProjectedFull);
            ...
            if (isGenericEvent && !string.IsNullOrEmpty(eventSourceInteropType))
            {
                ...
                writer.Write("""
                    .GetOrAdd(
                                key: thisObject,
                                valueFactory: static (_, thisReference) => Unsafe.As<
                    """, isMultiline: true);
                writer.Write(eventSourceProjectedFull);
            ...
            else
            {
                ...
                writer.Write("""
                    .GetOrAdd(
                                key: thisObject,
                                valueFactory: static (_, thisReference) => new 
                    """, isMultiline: true);
                writer.Write(eventSourceProjectedFull);
