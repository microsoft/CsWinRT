...
/// <param name="HasNonBlittableStructInput">True when at least one In/Ref parameter's underlying type is a complex struct (needs marshaller initialisation).</param>
internal readonly record struct MethodSignatureMarshallingFacts(
    ...
    bool ReturnIsNonBlittableStruct,
    ...
    bool HasNonBlittableStructInput)
{
    /// <summary>
    ...
    public bool NeedsTryFinally =>
        ...
        || HasReceiveArray || ReturnIsNonBlittableStruct || HasNonBlittablePassArray
        || HasNonBlittableStructInput || ReturnIsSystemTypeForCleanup;
    ...
    public static MethodSignatureMarshallingFacts From(MethodSignatureInfo sig, AbiTypeKindResolver resolver)
    {
        ...
        bool returnIsNonBlittableStruct = returnShape == AbiTypeKind.NonBlittableStruct;
        ...
        foreach ((_, ParameterInfo p, ParameterCategory cat) in sig.EnumerateWithCategory())
        {
            ...
            if (!hasNonBlittableStructInput && cat.IsScalarInput()
                && resolver.IsNonBlittableStruct(p.Type.StripByRefAndCustomModifiers()))
            {
        ...
        return new MethodSignatureMarshallingFacts(
            ...
            ReturnIsNonBlittableStruct: returnIsNonBlittableStruct,
            ...
            HasNonBlittableStructInput: hasNonBlittableStructInput);
    }
}