...
//TODO: weakref rehydration as base class
/*
...
unsafe
{
    ...
    var ptr = WindowsRuntimeMarshal.ConvertToUnmanaged(hierarchyEAsHierarchyB);
    ...
    // Hold native object alive while letting go of RCW
    ptr = WindowsRuntimeMarshal.ConvertToUnmanaged(hierarchyEAsHierarchyC);
    ...
    // Hold native object alive while letting go of RCW
    ptr = WindowsRuntimeMarshal.ConvertToUnmanaged(hierarchyEAsHierarchyB2);
