...
public class DiagnosticAnalyzerTests
{
    ...
    [TestMethod]
    public async Task CollectionExpression_GeneratedCode_DoesNotWarn()
    {
        const string source = """
            // <auto-generated/>
            using System.Collections.Generic;
    ...
    [TestMethod]
    public async Task CollectionExpression_FlowingThroughGeneratedCode_Warns()
    {
        const string userSource = """
            ...
            class Test
            {
                void M(RuntimeClass api)
                {
                    Generated.Forward(api, {|CsWinRT1032:[1]|});
                }
            }
        ...
        const string generatedSource = """
            ...
            {
                public static void Forward(RuntimeClass api, IEnumerable<int> value)
                {
                    api.SetItems(value);
                }

                public static void GeneratedOnly(RuntimeClass api)
                {
                    api.SetItems([2]);
                }
            }
        ...
        await CSharpAnalyzerTest<CollectionExpressionAnalyzer>.VerifyAnalyzerAsync(
            sources:
            [
                ("/0/User.cs", userSource),
                ("/0/Generated.g.cs", generatedSource)
            ],
            editorconfig: [("CsWinRTAotOptimizerEnabled", "auto")],
            scopedEditorConfigs: []);
    }
    ...
    public async Task CollectionExpression_TargetingInterface_ReadOnly_NotEmpty_FlowingToWinRT_Warns()
    {
        const string source = """
            ...
            class Test
            {
                ...
                void ThroughNonGenericCollectionInterfaces(RuntimeClass api)
                {
                    IEnumerable<int> collection = {|CsWinRT1032:[30]|};
                    System.Collections.ICollection first = (System.Collections.ICollection)collection;
                    System.Collections.IList second = (System.Collections.IList)first;
                    api.SetItems((IEnumerable<int>)second);
                }
