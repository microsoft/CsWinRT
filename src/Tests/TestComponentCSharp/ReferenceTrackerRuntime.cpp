// Note: this source adapted from:
// https://github.com/dotnet/runtime/blob/master/src/tests/Interop/COM/ComWrappers/MockReferenceTrackerRuntime/ReferenceTrackerRuntime.cpp
...
//ITrackerObject * CreateTrackerObject_SkipTrackerRuntime()
//{
...
//ITrackerObject * 
void* 
CreateTrackerObject(IUnknown * outer, IUnknown * *inner)
{
