...
namespace winrt::TestComponentCSharp::implementation
{
    struct Class : ClassT<Class>
    {
        ...
        std::vector<EnumValue> _enums{ EnumValue::One, EnumValue::Two, EnumValue::Three };
        EnumStruct _enumStruct;
        winrt::event<Windows::Foundation::EventHandler<EnumStruct>> _enumStructChanged;
        std::vector<EnumStruct> _enumStructs{ EnumStruct{EnumValue::One}, EnumStruct{EnumValue::Two}, EnumStruct{EnumValue::Three} };
