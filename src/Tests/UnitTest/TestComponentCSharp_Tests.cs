...
namespace UnitTest
{
    ...
    public class TestCSharp
    {
        ...
        [Fact]
        public object Alpha_IntEventOverhead()
        {
        ...
        [Fact]
        public object Alpha_AddIntEventToNewEventSource()
        {
            ClassWithMarshalingRoutines instance = new ClassWithMarshalingRoutines();
            int z;
            System.EventHandler<int> s = (object sender, int value) => z = value;
        ...
        [Fact]
        public object Alpha_AddMultipleEventsToNewEventSource()
        {
            ClassWithMarshalingRoutines instance = new ClassWithMarshalingRoutines();
            int z;
            double y;
        ...
        [Fact]
        public object Alpha_AddAndInvokeIntEventOnNewEventSource()
        {
            ClassWithMarshalingRoutines instance = new ClassWithMarshalingRoutines();
            int z;
            System.EventHandler<int> s = (object sender, int value) => z = value;
        ...
        [Fact]
        public object Alpha_AddAndInvokeMultipleIntEventsToSameEventSource()
        {
            ClassWithMarshalingRoutines instance = new ClassWithMarshalingRoutines();
            int z;
            System.EventHandler<int> s = (object sender, int value) => z = value;
        ...
        [Fact]
        public int Alpha_InvokeIntEvent()
        {
            instance.RaiseIntChanged();
            return z2;
        }
        ...
        [Fact]
        public int Alpha_InvokeIntEventWithSenderCheck()
        {
        ...
        [Fact]
        public object Alpha_AddAndRemoveIntEventOnNewEventSource()
        {
            ClassWithMarshalingRoutines instance = new ClassWithMarshalingRoutines();
            int z;
            System.EventHandler<int> s = (object sender, int value) => z = value;
        ...
        [Fact]
        public object Alpha_NativeIntEventOverhead()
        {
        ...
        [Fact]
        public object Alpha_AddNativeIntEventToNewEventSource()
        {
            ManagedEvents events = new ManagedEvents();
            EventOperations operations = new EventOperations(events);
            operations.AddIntEvent();
        ...
        [Fact]
        public object Alpha_AddMultipleNativeEventsToNewEventSource()
        {
            ManagedEvents events = new ManagedEvents();
            EventOperations operations = new EventOperations(events);
            operations.AddIntEvent();
        ...
        [Fact]
        public object Alpha_AddAndInvokeNativeIntEventOnNewEventSource()
        {
            ManagedEvents events = new ManagedEvents();
            EventOperations operations = new EventOperations(events);
            operations.AddIntEvent();
        ...
        [Fact]
        public void Alpha_InvokeNativeIntEvent()
        {
            operations.FireIntEvent();
        }

        [Fact]
        public object Alpha_AddAndRemoveNativeIntEventOnNewEventSource()
        {
            ManagedEvents events = new ManagedEvents();
            EventOperations operations = new EventOperations(events);
            operations.AddIntEvent();
