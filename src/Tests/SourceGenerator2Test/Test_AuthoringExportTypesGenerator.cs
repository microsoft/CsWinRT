...
public class Test_AuthoringExportTypesGenerator
{
    ...
    public void ImplementableClass_DispatchesOnWindowsRuntimeClassName()
    {
        ...
        const string result = """
            ...
            [assembly: global::WindowsRuntime.InteropServices.WindowsRuntimeActivationFactoryAssembly]
    ...
    public void ImplementableClass_IsNotMarkedAsComponentAssembly()
    {
        ...
        // Either way the assembly joins the merged activation chain, so its exports stay reachable
        Assert.IsTrue(GetManagedExports(source, isCsWinRTComponent: false).Contains("WindowsRuntimeActivationFactoryAssembly]"));
        Assert.IsTrue(GetManagedExports(source, isCsWinRTComponent: true).Contains("WindowsRuntimeActivationFactoryAssembly]"));
    }
