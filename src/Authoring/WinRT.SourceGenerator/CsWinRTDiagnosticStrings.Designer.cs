...
namespace WinRT.SourceGenerator {
    ...
    internal class CsWinRTDiagnosticStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Collection expressions targeting interface type &apos;{0}&apos; do not have a defined concrete type, and are not supported for trimming and AOT compatibility with WinRT scenarios (consider changing the target type to be a concrete type, or avoid using a collection expression in this case).
        /// </summary>
