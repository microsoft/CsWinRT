...
namespace WinRT.SourceGenerator
{
    ...
    // Adapted from https://github.com/CommunityToolkit/dotnet/blob/main/src/CommunityToolkit.Mvvm.SourceGenerators/Helpers/EquatableArray%7BT%7D.cs
    /// <summary>
        ...
        where T : IEquatable<T>
    {
        ...
        public override int GetHashCode()
        {
            ...
            {
                hashCode = unchecked((hashCode * (int)0xA5555529) + item.GetHashCode());
            }
