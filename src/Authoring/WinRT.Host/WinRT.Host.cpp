...
[[noreturn]] inline __declspec(noinline) void throw_hostfxr_hresult(hresult const result)
{
    ...
    {
        { InvalidArgFailure, 102 },
        { CoreHostLibLoadFailure, 103 },
        { CoreHostLibMissingFailure, 104 },
		{ CoreHostEntryPointFailure, 105 },
        { CoreHostCurHostFindFailure, 106 },
        { CoreClrResolveFailure, 107 },
        { CoreClrBindFailure, 108 },
        { CoreClrInitFailure, 109 },
        { CoreClrExeFailure, 110 },
        { ResolverInitFailure, 111 },
        { ResolverResolveFailure, 112 },
        { LibHostCurExeFindFailure, 113 },
        { LibHostInitFailure, 114 },
        { LibHostSdkFindFailure, 115 },
        { LibHostInvalidArgs, 116 },
        { InvalidConfigFile, 117 },
        { AppArgNotRunnable, 118 },
        { AppHostExeNotBoundFailure, 119 },
        { FrameworkMissingFailure, 120 },
        { HostApiFailed, 121 },
        { HostApiBufferTooSmall, 122 },
        { LibHostUnknownCommand, 123 },
        { LibHostAppRootFindFailure, 124 },
        { SdkResolverResolveFailure, 125 },
        { FrameworkCompatFailure, 126 },
        { FrameworkCompatRetry, 127 },
        { BundleExtractionFailure, 128 },
        { BundleExtractionIOError, 129 },
        { LibHostDuplicateProperty, 130 },
        { HostApiUnsupportedVersion, 131 },
        { HostInvalidState, 132 },
        { HostPropertyNotFound, 133 },
        { CoreHostIncompatibleConfig, 134 },
        { HostApiUnsupportedScenario, 135 },
    };
    ...
    for (auto&& elem : hostfxr_status_messages)
    {
        if (elem.status == result)
        {
            ...
            strErrorMessage.LoadString(elem.resourceID);
            throw hresult_error(result, strErrorMessage);
        }
    }
