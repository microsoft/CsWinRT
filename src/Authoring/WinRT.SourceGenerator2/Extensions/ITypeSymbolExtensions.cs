...
internal static class ITypeSymbolExtensions
{
    extension(ITypeSymbol symbol)
    {
        ...
        /// <param name="generatedCodeAttributeType">
        /// If not <see langword="null"/>, implementations annotated with <c>[GeneratedCode]</c> of this
        /// type and whose first constructor argument matches <paramref name="generatorName"/> are excluded.
        /// </param>
        /// <param name="generatorName">
        /// The generator name to match against the first constructor argument of <c>[GeneratedCode]</c>.
        /// Only used when <paramref name="generatedCodeAttributeType"/> is not <see langword="null"/>.
        /// </param>
        /// <returns>Whether <paramref name="symbol"/> has any implemented members for <paramref name="interfaceType"/>.</returns>
        public bool HasAnyImplementedMembersForInterface(
            INamedTypeSymbol interfaceType,
            INamedTypeSymbol? generatedCodeAttributeType = null,
            string? generatorName = null)
        {
            ...
            {
                if (symbol.FindImplementationForInterfaceMember(member) is not { } implementation)
                {
                    continue;
                }

                // If requested, skip implementations generated by the specified generator
                if (generatedCodeAttributeType is not null &&
                    HasGeneratedCodeAttributeWithName(implementation, generatedCodeAttributeType, generatorName))
                {
                    continue;
                }
