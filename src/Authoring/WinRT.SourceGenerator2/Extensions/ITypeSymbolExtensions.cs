...
internal static class ITypeSymbolExtensions
{
    extension(ITypeSymbol symbol)
    {
        ...
        /// <summary>
        /// Enumerates all members of a specified interface that have implementations on the given <see cref="ITypeSymbol"/>.
        /// </summary>
        /// <param name="interfaceType">The interface type to enumerate member implementations for.</param>
        /// <returns>The sequence of all implemented members for <paramref name="interfaceType"/> on <paramref name="symbol"/>.</returns>
        public IEnumerable<ISymbol> EnumerateImplementedMembersForInterface(INamedTypeSymbol interfaceType)
        {
