...
internal ref struct PooledArrayBuilder<T> : IDisposable
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="PooledArrayBuilder{T}"/> object.
    /// </summary>
    ...
    private sealed class Writer : IList<T>, IReadOnlyList<T>
    {
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.WrittenSpan"/>
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.Advance"/>
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.Add"/>
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.AddRange"/>
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.Insert"/>
        ...
        /// <inheritdoc cref="PooledArrayBuilder{T}.Clear"/>
        public void Clear()
        {
...
/// <summary>
/// Private helpers for the <see cref="PooledArrayBuilder{T}"/> type.
/// </summary>
