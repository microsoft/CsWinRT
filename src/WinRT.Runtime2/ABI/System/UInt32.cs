...
public static unsafe class UInt32Marshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, in WellKnownInterfaceIds.IID_IReferenceOfUInt);
    }
...
file static class UInt32InterfaceEntriesImpl
{
    ...
    {
        Entries.IReferenceOfUInt32.IID = WellKnownInterfaceIds.IID_IReferenceOfUInt;
...
internal sealed unsafe class UInt32ComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(ref Unsafe.AsRef(in UInt32InterfaceEntriesImpl.Entries));
    }

    /// <inheritdoc/>
    public override object CreateObject(void* value)
    {
        return WindowsRuntimeValueTypeMarshaller.UnboxToManagedUnsafe<uint>(value, in WellKnownInterfaceIds.IID_IReferenceOfUInt);
    }
}
...
file unsafe struct UInt32ReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, uint*, HRESULT> Value;
}
...
file static unsafe class UInt32ReferenceImpl
{
    ...
    public static HRESULT Value(void* thisPtr, uint* result)
    {
        if (result is null)
        {
...
file static unsafe class UInt32PropertyValueImpl
{
    ...
    static UInt32PropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetUInt32 = &UInt32ReferenceImpl.Value;
