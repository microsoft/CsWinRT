...
[assembly: TypeMapAssociation<WindowsRuntimeComWrappersTypeMapGroup>(typeof(ushort), typeof(ABI.System.UInt16))]
...
/// <summary>
/// Marshaller for <see cref="ushort"/>.
/// </summary>
...
public static unsafe class UInt16Marshaller
{
    ...
    public static WindowsRuntimeObjectReferenceValue BoxToUnmanaged(ushort? value)
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, CreateComInterfaceFlags.None, in WellKnownInterfaceIds.IID_IReferenceOfUShort);
    }

    /// <inheritdoc cref="WindowsRuntimeValueTypeMarshaller.UnboxToManaged(void*)"/>
    public static ushort? UnboxToManaged(void* value)
    {
        return WindowsRuntimeValueTypeMarshaller.UnboxToManaged<ushort>(value);
    }
}

/// <summary>
/// The set of <see cref="ComInterfaceEntry"/> values for <see cref="ushort"/>.
/// </summary>
file struct UInt16InterfaceEntries
{
    public ComInterfaceEntry IReferenceOfUInt16;
...
/// <summary>
/// The implementation of <see cref="UInt16InterfaceEntries"/>.
/// </summary>
file static class UInt16InterfaceEntriesImpl
{
    /// <summary>
    /// The <see cref="UInt16InterfaceEntries"/> value for <see cref="ushort"/>.
    /// </summary>
    [FixedAddressValueType]
    public static readonly UInt16InterfaceEntries Entries;

    /// <summary>
    /// Initializes <see cref="Entries"/>.
    /// </summary>
    static UInt16InterfaceEntriesImpl()
    {
        Entries.IReferenceOfUInt16.IID = WellKnownInterfaceIds.IID_IReferenceOfUShort;
        Entries.IReferenceOfUInt16.Vtable = UInt16ReferenceImpl.Vtable;
        Entries.IPropertyValue.IID = WellKnownInterfaceIds.IID_IPropertyValue;
        Entries.IPropertyValue.Vtable = UInt16PropertyValueImpl.Vtable;
...
/// <summary>
/// A custom <see cref="WindowsRuntimeComWrappersMarshallerAttribute"/> implementation for <see cref="ushort"/>.
/// </summary>
internal sealed unsafe class UInt16ComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    /// <inheritdoc/>
    public override void* GetOrCreateComInterfaceForObject(object value)
    {
        return WindowsRuntimeComWrappersMarshaller.GetOrCreateComInterfaceForObject(value, CreateComInterfaceFlags.None);
    }

    /// <inheritdoc/>
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        count = sizeof(UInt16InterfaceEntries) / sizeof(ComInterfaceEntry);

        return (ComInterfaceEntry*)Unsafe.AsPointer(in UInt16InterfaceEntriesImpl.Entries);
    }
    ...
    public override object CreateObject(void* value, out CreatedWrapperFlags wrapperFlags)
    {
        ...
        return WindowsRuntimeValueTypeMarshaller.UnboxToManagedUnsafe<ushort>(value, in WellKnownInterfaceIds.IID_IReferenceOfUShort);
    }
}

/// <summary>
/// Binding type for the <c>IReference`1</c> implementation for <see cref="ushort"/>.
/// </summary>
[StructLayout(LayoutKind.Sequential)]
file unsafe struct UInt16ReferenceVftbl
{
...
/// <summary>
/// The <c>IReference`1</c> implementation for <see cref="ushort"/>.
/// </summary>
file static unsafe class UInt16ReferenceImpl
{
    /// <summary>
    /// The <see cref="UInt16ReferenceVftbl"/> value for the managed <c>IReference`1</c> implementation.
    /// </summary>
    [FixedAddressValueType]
    private static readonly UInt16ReferenceVftbl Vftbl;

    /// <summary>
    /// Initializes <see cref="Vftbl"/>.
    /// </summary>
    static UInt16ReferenceImpl()
    {
    ...
    public static HRESULT get_Value(void* thisPtr, ushort* result)
    {
        ...
        try
        {
            *result = (ushort)ComInterfaceDispatch.GetInstance<object>((ComInterfaceDispatch*)thisPtr);
...
/// <summary>
/// The <c>IPropertyValue</c> implementation for <see cref="ushort"/>.
/// </summary>
file static unsafe class UInt16PropertyValueImpl
{
    /// <summary>
    ...
    /// Initializes <see cref="Vftbl"/>.
    /// </summary>
    static UInt16PropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
    ...
    private static HRESULT GetUInt8(void* thisPtr, byte* value)
    {
        ...
        try
        {
            ushort unboxedValue = (ushort)ComInterfaceDispatch.GetInstance<object>((ComInterfaceDispatch*)thisPtr);
    ...
    private static HRESULT GetInt32(void* thisPtr, int* value)
    {
        ...
        try
        {
            *value = (ushort)ComInterfaceDispatch.GetInstance<object>((ComInterfaceDispatch*)thisPtr);
