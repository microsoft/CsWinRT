...
[assembly: TypeMapAssociation<WindowsRuntimeTypeMapGroup>(typeof(ulong), typeof(ABI.System.UInt64))]
...
public static unsafe class UInt64Marshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, in WellKnownInterfaceIds.IID_IReferenceOfULong);
    }
...
file static class UInt64InterfaceEntriesImpl
{
    ...
    {
        Entries.IReferenceOfUInt64.IID = WellKnownInterfaceIds.IID_IReferenceOfULong;
...
internal sealed unsafe class UInt64ComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(ref Unsafe.AsRef(in UInt64InterfaceEntriesImpl.Entries));
    }
