...
[assembly: TypeMapAssociation<WindowsRuntimeTypeMapGroup>(typeof(char), typeof(ABI.System.Char))]
...
public static unsafe class CharMarshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, in WellKnownInterfaceIds.IID_IReferenceOfChar);
    }
...
internal sealed unsafe class CharComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(ref Unsafe.AsRef(in CharInterfaceEntriesImpl.Entries));
    }
...
file unsafe struct CharReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, char*, HRESULT> Value;
}
...
file static unsafe class CharReferenceImpl
{
    ...
    public static HRESULT Value(void* thisPtr, char* result)
    {
        if (result is null)
        {
...
file static unsafe class CharPropertyValueImpl
{
    ...
    static CharPropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetChar16 = &CharReferenceImpl.Value;
