...
file unsafe struct SingleReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, float*, HRESULT> Value;
}
...
file static unsafe class SingleReferenceImpl
{
    ...
    public static HRESULT Value(void* thisPtr, float* result)
    {
        if (result is null)
        {
...
file static unsafe class SinglePropertyValueImpl
{
    ...
    static SinglePropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetSingle = &SingleReferenceImpl.Value;
