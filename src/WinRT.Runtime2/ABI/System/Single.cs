...
[assembly: TypeMapAssociation<WindowsRuntimeComWrappersTypeMapGroup>(typeof(float), typeof(ABI.System.Single))]
...
public static unsafe class SingleMarshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, CreateComInterfaceFlags.None, in WellKnownInterfaceIds.IID_IReferenceOfFloat);
    }
...
internal sealed unsafe class SingleComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(in SingleInterfaceEntriesImpl.Entries);
    }
