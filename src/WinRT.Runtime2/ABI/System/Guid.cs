...
file static unsafe class GuidPropertyValueImpl
{
    ...
    static GuidPropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetGuidArray = (delegate* unmanaged[MemberFunction]<void*, uint*, global::System.Guid**, HRESULT>)(delegate* unmanaged[MemberFunction]<void*, uint*, void**, HRESULT>)&IPropertyValueImpl.ThrowStubForGetArrayOverloads;
