...
[assembly: TypeMapAssociation<WindowsRuntimeTypeMapGroup>(typeof(long), typeof(ABI.System.Int64))]
...
internal sealed unsafe class Int64ComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(ref Unsafe.AsRef(in Int64InterfaceEntriesImpl.Entries));
    }
...
file unsafe struct Int64ReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, long*, HRESULT> Value;
}
...
file static unsafe class Int64ReferenceImpl
{
    ...
    public static HRESULT Value(void* thisPtr, long* result)
    {
        if (result is null)
        {
...
file static unsafe class Int64PropertyValueImpl
{
    ...
    static Int64PropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetInt64 = &Int64ReferenceImpl.Value;
