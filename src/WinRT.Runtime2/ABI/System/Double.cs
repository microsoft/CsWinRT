...
[assembly: TypeMapAssociation<WindowsRuntimeTypeMapGroup>(typeof(double), typeof(ABI.System.Double))]
...
public static unsafe class DoubleMarshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, in WellKnownInterfaceIds.IID_IReferenceOfDouble);
    }
...
internal sealed unsafe class DoubleComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override ComInterfaceEntry* ComputeVtables(out int count)
    {
        ...
        return (ComInterfaceEntry*)Unsafe.AsPointer(ref Unsafe.AsRef(in DoubleInterfaceEntriesImpl.Entries));
    }
