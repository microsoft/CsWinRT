...
[assembly: TypeMap<WindowsRuntimeComWrappersTypeMapGroup>(
    value: "Windows.Foundation.IReference`1<Int16>",
    target: typeof(ABI.System.Int16),
    trimTarget: typeof(short))]
#pragma warning restore IL2026 // Members annotated with 'RequiresUnreferencedCodeAttribute' require dynamic access otherwise can break functionality when trimming application code

[assembly: TypeMapAssociation<WindowsRuntimeComWrappersTypeMapGroup>(typeof(short), typeof(ABI.System.Int16))]
...
[WindowsRuntimeClassName("Windows.Foundation.IReference`1<Int16>")]
...
public static unsafe class Int16Marshaller
{
    ...
    {
        return WindowsRuntimeValueTypeMarshaller.BoxToUnmanaged(value, CreateComInterfaceFlags.None, in WellKnownWindowsInterfaceIIDs.IID_IReferenceOfShort);
    }
...
file static class Int16InterfaceEntriesImpl
{
    ...
    {
        Entries.IReferenceOfInt16.IID = WellKnownWindowsInterfaceIIDs.IID_IReferenceOfShort;
...
internal sealed unsafe class Int16ComWrappersMarshallerAttribute : WindowsRuntimeComWrappersMarshallerAttribute
{
    ...
    public override object CreateObject(void* value, out CreatedWrapperFlags wrapperFlags)
    {
        ...
        return WindowsRuntimeValueTypeMarshaller.UnboxToManagedUnsafe<short>(value, in WellKnownWindowsInterfaceIIDs.IID_IReferenceOfShort);
    }
}
...
file unsafe struct Int16ReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, short*, HRESULT> get_Value;
}
...
file static unsafe class Int16ReferenceImpl
{
    ...
    public static HRESULT get_Value(void* thisPtr, short* result)
    {
        if (result is null)
        {
...
file static unsafe class Int16PropertyValueImpl
{
    ...
    static Int16PropertyValueImpl()
    {
        *(IInspectableVftbl*)Unsafe.AsPointer(ref Vftbl) = *(IInspectableVftbl*)IInspectableImpl.Vtable;
        ...
        Vftbl.GetInt16 = &Int16ReferenceImpl.get_Value;
