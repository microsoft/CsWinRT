...
public static class InterfaceIIDs
{
    ...
    public static ref readonly Guid IID_System_Collections_IBindableIterable
    {
    ...
    public static ref readonly Guid IID_System_Collections_IBindableIterator
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_Collections_IBindableVector
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_Collections_Specialized_INotifyCollectionChanged
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_ComponentModel_INotifyDataErrorInfo
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_ComponentModel_INotifyPropertyChanged
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_IDisposable
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_IServiceProvider
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
    ...
    public static ref readonly Guid IID_System_Windows_Input_ICommand
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]   
