...
/// <inheritdoc cref="WindowsRuntimeObject"/>
public unsafe partial class WindowsRuntimeObject
{
    ...
    /// <inheritdoc cref="IDynamicInterfaceCastable.GetInterfaceImplementation"/>
    private static RuntimeTypeHandle GetInterfaceImplementation(RuntimeTypeHandle interfaceType)
    {
    ...
    private bool IsInterfaceImplemented(RuntimeTypeHandle interfaceType, bool throwIfNotImplemented)
    {
    ...
    /// <inheritdoc cref="IUnmanagedVirtualMethodTableProvider.GetVirtualMethodTableInfoForKey"/>
    private VirtualMethodTableInfo GetVirtualMethodTableInfoForKey(Type type)
    {
    ...
    private CustomQueryInterfaceResult GetInterface(ref Guid iid, out nint ppv)
    {
