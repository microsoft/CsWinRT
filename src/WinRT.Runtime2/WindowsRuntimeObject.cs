    ...
    ICustomQueryInterface
{
        ...
        get
        {
            ...
            WindowsRuntimeObjectReference InitializeInspectableObjectReference()
            {
                _ = Interlocked.CompareExchange(
                    ...
                    value: NativeObjectReference.As(in WellKnownInterfaceIIDs.IID_IInspectable),
                    comparand: null);
    ...
    CustomQueryInterfaceResult ICustomQueryInterface.GetInterface(ref Guid iid, out nint ppv)
    {
        ...
        if (IsOverridableInterface(in iid) || WellKnownInterfaceIIDs.IID_IInspectable == iid || WellKnownInterfaceIIDs.IID_IWeakReference == iid)
        {
            ppv = (nint)null;
