...
file static class QuaternionInterfaceEntriesImpl
{
    ...
    {
        Entries.IReferenceOfQuaternion.IID = WellKnownInterfaceIds.IID_IReferenceQuaternion;
        Entries.IReferenceOfQuaternion.Vtable = QuaternionReferenceImpl.AbiToProjectionVftablePtr;
