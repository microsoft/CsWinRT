...
file static class PlaneInterfaceEntriesImpl
{
    ...
    {
        Entries.IReferenceOfPlane.IID = WellKnownInterfaceIds.IID_IReferencePlane;
        Entries.IReferenceOfPlane.Vtable = PlaneReferenceImpl.AbiToProjectionVftablePtr;
...
file unsafe struct PlaneReferenceVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, global::System.Numerics.Plane*, HRESULT> Value;
}
