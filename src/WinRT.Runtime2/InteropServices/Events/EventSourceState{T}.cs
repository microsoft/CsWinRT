    ...
    where T : MulticastDelegate
{
    ...
    internal void InitalizeReferenceTracking(void* eventInvokePtr)
    {
        ...
        HRESULT hresult = IUnknownVftbl.QueryInterfaceUnsafe(eventInvokePtr, in WellKnownInterfaceIIDs.IID_IReferenceTrackerTarget, out _referenceTrackerTargetPtr);
