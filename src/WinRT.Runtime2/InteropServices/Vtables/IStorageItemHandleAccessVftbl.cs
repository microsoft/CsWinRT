...
internal unsafe struct IStorageItemHandleAccessVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, uint, uint, uint, nint, nint*, HRESULT> Create;
    ...
    public static HRESULT CreateUnsafe(void* thisPtr, uint accessOptions, uint sharingOptions, uint options, nint oplockBreakingHandler, nint* interopHandle)
    {
