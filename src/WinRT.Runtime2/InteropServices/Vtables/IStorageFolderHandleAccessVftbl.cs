...
internal unsafe struct IStorageFolderHandleAccessVftbl
{
    ...
    public delegate* unmanaged[MemberFunction]<void*, char*, HANDLE_CREATION_OPTIONS, HANDLE_ACCESS_OPTIONS, HANDLE_SHARING_OPTIONS, HANDLE_OPTIONS, void*, HANDLE*, HRESULT> Create;
