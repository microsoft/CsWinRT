...
internal partial class ProjectionGenerator
{
    ...
    private static void WriteTypeMapAssemblyTargets(ProjectionGeneratorArgs args, ProjectionGeneratorProcessingState processingState)
    {
        ...
        // 'WinRT.Projection' is generated only when there are non-Windows-SDK projection
        // references in scope (which is the typical aggregator case). It is harmless to
        // include in the target list either way: the runtime tolerates a missing assembly
        // referenced by '[TypeMapAssemblyTarget]' (it just contributes no entries).
