...
msbuild -t:restore -t:Benchmarks /p:RestorePackagesConfig=true /p:platform=x64 /p:configuration=release /p:solutiondir=%~dp0 /p:IsDotnetBuild=false %this_dir%cswinrt.slnx
