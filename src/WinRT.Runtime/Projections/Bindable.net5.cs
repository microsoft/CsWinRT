    ...
    unsafe interface IList : global::System.Collections.IList, global::Microsoft.UI.Xaml.Interop.IBindableVector
    {
        ...
        public sealed class FromAbiHelper : global::System.Collections.IList
        {
            ...
            public int Count
            {
                ...
                { 
                    ...
                    {
                        throw new InvalidOperationException(WinRTRuntimeWinRTRuntimeErrorStrings.InvalidOperation_CollectionBackingListTooLarge);
                    }
            ...
            public void CopyTo(Array array, int arrayIndex)
            {
                ...
                if (array.Rank != 1)
                    throw new ArgumentException(WinRTRuntimeWinRTRuntimeErrorStrings.Arg_RankMultiDimNotSupported);
                ...
                if (srcLen > (destLen - (arrayIndex - destLB)))
                    throw new ArgumentException(WinRTRuntimeWinRTRuntimeErrorStrings.Argument_InsufficientSpaceToCopyCollection);

                if (arrayIndex - destLB > destLen)
                    throw new ArgumentException(WinRTRuntimeWinRTRuntimeErrorStrings.Argument_IndexOutOfArrayBounds);
        ...
        public sealed class ToAbiHelper : IBindableVector
        {
            ...
            public object GetAt(uint index)
            {
                ...
                {
                    throw ex.GetExceptionForHR(ExceptionHelpers.E_BOUNDS, WinRTRuntimeWinRTRuntimeErrorStrings.ArgumentOutOfRange_Index);
                }
            }
            ...
            public void RemoveAtEnd()
            {
                if (_list.Count == 0)
                {
                    Exception e = new InvalidOperationException(WinRTRuntimeWinRTRuntimeErrorStrings.InvalidOperation_CannotRemoveLastFromEmptyCollection);
            ...
            private static void EnsureIndexInt32(uint index, int listCapacity)
            {
                ...
                {
                    Exception e = new ArgumentOutOfRangeException(nameof(index), WinRTRuntimeWinRTRuntimeErrorStrings.ArgumentOutOfRange_IndexLargerThanMaxValue);
                    e.SetHResult(ExceptionHelpers.E_BOUNDS);
                    throw e;
                }
            }
