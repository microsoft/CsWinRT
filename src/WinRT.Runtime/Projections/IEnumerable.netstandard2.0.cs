        ...
        public class FromAbiHelper : global::System.Collections.Generic.IEnumerator<T>
        {
            ...
            public T Current
            {
                get
                {
                    ...
                    if (!m_isInitialized)
                        throw new InvalidOperationException(WinRTRuntimeLocalizationResources.InvalidOperation_EnumNotStarted);
                    // The enumerator has reached the end of the collection
                    if (!m_hadCurrent)
                        throw new InvalidOperationException(WinRTRuntimeLocalizationResources.InvalidOperation_EnumEnded);
                    return m_current;
                }
            }
            ...
            public bool MoveNext()
            {
                ...
                catch (Exception e)
                {
                    ...
                    {
                        throw new InvalidOperationException(WinRTRuntimeLocalizationResources.InvalidOperation_EnumFailedVersion);
                    }
                    else
                    {
                        throw;
