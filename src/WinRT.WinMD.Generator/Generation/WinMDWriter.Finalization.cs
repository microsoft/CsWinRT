...
internal sealed partial class WinMDWriter
{
    ...
    ///     .NET projection types to WinRT equivalents.</item>
    ...
    /// <param name="interfaceMethod">The interface method to match against.</param>
    /// <param name="mapInterfaceTypes">Whether to map .NET projection types to WinRT equivalents when comparing.</param>
    ...
    /// <summary>
    /// Checks if a .NET projection type name maps to a WinRT type name via the <see cref="Helpers.TypeMapper"/>.
    /// </summary>
    /// <param name="dotNetTypeName">The .NET projection type name (e.g. <c>"System.Collections.Generic.IEnumerable`1"</c>).</param>
    /// <param name="winrtTypeName">The WinRT type name to compare against (e.g. <c>"Windows.Foundation.Collections.IIterable`1"</c>).</param>
    /// <returns><see langword="true"/> if the .NET type maps to the WinRT type; otherwise, <see langword="false"/>.</returns>
    ...
    /// </summary>
    /// <remarks>
    /// WinRT requires that overloaded methods have unique names. This method finds method groups
