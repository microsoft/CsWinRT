...
#pragma warning restore CA2002
    ...
    internal static class InterfaceIIDs
    {
        ...
        internal static readonly Guid IReferenceArrayOfInt32_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0xA5, 0x80, 0xD0, 0xA6, 0x87, 0xB0, 0xC2, 0x5B, 0x9A, 0x9F, 0x5C, 0xD6, 0x87, 0xB4, 0xD1, 0xF7 }));
        internal static readonly Guid IReferenceArrayOfString_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x8E, 0x68, 0x85, 0x03, 0xC7, 0xE3, 0x5E, 0x5C, 0xA3, 0x89, 0x55, 0x24, 0xED, 0xE3, 0x49, 0xF1 }));
        internal static readonly Guid IReferenceArrayOfByte_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x83, 0x26, 0xF2, 0x2A, 0x34, 0x37, 0xD0, 0x56, 0xA6, 0x0E, 0x68, 0x8C, 0xC8, 0x5D, 0x16, 0x19 }));
        internal static readonly Guid IReferenceArrayOfInt16_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0xD7, 0x8F, 0x2F, 0x91, 0xC0, 0xAD, 0x60, 0x5D, 0xA8, 0x96, 0x7E, 0xD7, 0x60, 0x89, 0xCC, 0x5B }));
        internal static readonly Guid IReferenceArrayOfUInt16_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0xDD, 0xA2, 0x24, 0x66, 0xF7, 0x83, 0x9C, 0x51, 0x9D, 0x55, 0xBB, 0x1F, 0x65, 0x60, 0x45, 0x6B }));
        internal static readonly Guid IReferenceArrayOfUInt32_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x68, 0x4B, 0x37, 0x97, 0x87, 0xEB, 0xCC, 0x56, 0xB1, 0x8E, 0x27, 0xEF, 0x0F, 0x9C, 0xFC, 0x0C }));
        internal static readonly Guid IReferenceArrayOfInt64_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x71, 0x32, 0x33, 0x6E, 0x2A, 0x2E, 0x55, 0x59, 0x87, 0x90, 0x83, 0x6C, 0x76, 0xEE, 0x53, 0xB6 }));
        internal static readonly Guid IReferenceArrayOfUInt64_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x34, 0x04, 0xB6, 0x38, 0x7C, 0xD6, 0x3E, 0x52, 0x9D, 0x0E, 0x24, 0xD6, 0x43, 0x41, 0x10, 0x73 }));
        internal static readonly Guid IReferenceArrayOfSingle_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x83, 0xEA, 0xB1, 0x6A, 0x41, 0xCB, 0x99, 0x5F, 0x92, 0xCC, 0x23, 0xBD, 0x43, 0x36, 0xA1, 0xFB }));
        internal static readonly Guid IReferenceArrayOfDouble_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x53, 0xF2, 0x01, 0xD3, 0xA3, 0xE0, 0x2B, 0x5D, 0x9A, 0x41, 0xA4, 0xD6, 0x2B, 0xEC, 0x46, 0x23 }));
        internal static readonly Guid IReferenceArrayOfChar_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0xAB, 0x5A, 0x09, 0xA4, 0x7D, 0xEB, 0x82, 0x57, 0x8F, 0xAD, 0x16, 0x09, 0xDE, 0xA2, 0x49, 0xAD }));
        internal static readonly Guid IReferenceArrayOfBoolean_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x66, 0x26, 0xE7, 0xE8, 0xCC, 0x48, 0x3F, 0x59, 0xBA, 0x85, 0x26, 0x63, 0x49, 0x69, 0x56, 0xE3 }));
        internal static readonly Guid IReferenceArrayOfGuid_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x38, 0x98, 0xCF, 0xEE, 0xC2, 0xC1, 0x4A, 0x5B, 0x97, 0x6F, 0xCE, 0xC2, 0x61, 0xAE, 0x1D, 0x55 }));
        internal static readonly Guid IReferenceArrayOfDateTimeOffset_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x94, 0x95, 0x8E, 0x1B, 0x8E, 0x58, 0x07, 0x5A, 0x9E, 0x65, 0x07, 0x31, 0xA4, 0xC9, 0xA2, 0xDB }));
        internal static readonly Guid IReferenceArrayOfTimeSpan_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x7D, 0x19, 0x73, 0xAD, 0xFA, 0x2C, 0xA6, 0x57, 0x89, 0x93, 0x9F, 0xAC, 0x40, 0xFE, 0xB7, 0x91 }));
        internal static readonly Guid IReferenceArrayOfObject_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0x4F, 0xA8, 0xD7, 0x9C, 0x80, 0x0C, 0xC5, 0x59, 0xB4, 0x4E, 0x97, 0x78, 0x41, 0xBB, 0x43, 0xD9 }));
        internal static readonly Guid IReferenceArrayOfType_IID = new Guid(new global::System.ReadOnlySpan<byte>(new byte[] { 0xA7, 0x57, 0x84, 0xDA, 0xEB, 0xC2, 0xA1, 0x5D, 0x80, 0xBE, 0x71, 0x32, 0xA2, 0xE1, 0xBF, 0xA4 }));
#else
