            ...
            { "Windows.Foundation",
                {
                    ...
                    { "AsyncActionProgressHandler`1", "Windows.Foundation", "AsyncActionProgressHandler`1"},
                    { "AsyncActionWithProgressCompletedHandler`1", "Windows.Foundation", "AsyncActionWithProgressCompletedHandler`1"},
                    { "AsyncOperationCompletedHandler`1", "Windows.Foundation", "AsyncOperationCompletedHandler`1"},
                    { "AsyncOperationProgressHandler`2", "Windows.Foundation", "AsyncOperationProgressHandler`2"},
                    { "AsyncOperationWithProgressCompletedHandler`2", "Windows.Foundation", "AsyncOperationWithProgressCompletedHandler`2"},
