...
var docs = new[]
{
	XDocument.Load(@"C:\Program Files (x86)\Windows Kits\10\Platforms\UAP\10.0.26100.0\PreviousPlatforms.xml"),
	XDocument.Load(@"C:\Program Files (x86)\Windows Kits\10\Extension SDKs\WindowsDesktop\10.0.26100.0\PreviousPlatforms.xml"),
};
...
var contracts =
	...
	let ContractNumber = int.Parse(ContractVersion.Split('.')[0])
