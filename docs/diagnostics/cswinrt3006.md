...
For instance, the following sample generates CSWINRT3006:

```csharp
using WindowsRuntime;

// CSWINRT3006: the implementable class attribute is a private implementation detail
