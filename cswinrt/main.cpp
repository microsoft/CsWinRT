...
%
            ...
            bind_each([&](writer& w, auto&& ns)
            {
                ...
                {
                    if (settings.filter.includes(type.abi_namespace, type.abi_name))
                    {
