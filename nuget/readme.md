...
| CsWinRTAotOptimizerEnabled | *Auto \| OptIn \| true \| false | Enables the C#/WinRT AOT optimizer. WinRT types can opt-in to AOT optimization by adding the `[GeneratedWinRTExposedType]` attribute. |
